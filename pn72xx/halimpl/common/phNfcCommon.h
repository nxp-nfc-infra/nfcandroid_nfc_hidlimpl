/******************************************************************************
 *
 *  Copyright 2010-2018, 2021,2023-2024 NXP
 *
...
#define CLK_FREQ_UNDEF 9
#define CLK_FREQ_13MHZ 10
#define CLK_FREQ_19_2MHZ 11
#define CLK_FREQ_26MHZ 12
#define CLK_FREQ_38_4MHZ 13
#define CLK_FREQ_52MHZ 14

static const uint8_t PN7160_SET_CONFIG_CMD_PLL_13MHZ[] = {
    0x20, 0x02, 0x0C, 0x01, 0xA0, 0x20, 0x08, 0x08,
    0x52, 0xA2, 0x02, 0x30, 0x01, 0xE1, 0x02};
static const uint8_t PN7160_SET_CONFIG_CMD_DPLL_13MHZ[] = {
    0x20, 0x02, 0x0C, 0x01, 0xA0, 0x26, 0x08, 0x40,
    0x42, 0xA3, 0x02, 0x88, 0x01, 0xE2, 0x02};
static const uint8_t PN7160_SET_CONFIG_CMD_PLL_19_2MHZ[] = {
    0x20, 0x02, 0x0C, 0x01, 0xA0, 0x20, 0x08, 0x88,
    0x51, 0xE3, 0x02, 0xB8, 0x21, 0xE1, 0x02};
static const uint8_t PN7160_SET_CONFIG_CMD_DPLL_19_2MHZ[] = {
    0x20, 0x02, 0x0C, 0x01, 0xA0, 0x26, 0x08, 0x88,
    0x01, 0xE2, 0x02, 0xF0, 0x00, 0xA2, 0x01};
static const uint8_t PN7160_SET_CONFIG_CMD_PLL_24MHZ[] = {
    0x20, 0x02, 0x0C, 0x01, 0xA0, 0x20, 0x08, 0x28,
    0xC2, 0xA2, 0x83, 0x88, 0x11, 0xE1, 0x02};
static const uint8_t PN7160_SET_CONFIG_CMD_DPLL_24MHZ[] = {
    0x20, 0x02, 0x0C, 0x01, 0xA0, 0x26, 0x08, 0x38,
    0x41, 0xD3, 0x02, 0x88, 0x01, 0xE2, 0x02};
static const uint8_t PN7160_SET_CONFIG_CMD_PLL_26MHZ[] = {
    0x20, 0x02, 0x0C, 0x01, 0xA0, 0x20, 0x08, 0x08,
    0x52, 0xA2, 0x82, 0x30, 0x01, 0xE1, 0x02};
static const uint8_t PN7160_SET_CONFIG_CMD_DPLL_26MHZ[] = {
    0x20, 0x02, 0x0C, 0x01, 0xA0, 0x26, 0x08, 0x20,
    0x41, 0xA3, 0x01, 0x88, 0x01, 0xE2, 0x02};
static const uint8_t PN7160_SET_CONFIG_CMD_PLL_32MHZ[] = {
    0x20, 0x02, 0x0C, 0x01, 0xA0, 0x20, 0x08, 0xB8,
    0x51, 0xA3, 0x82, 0x88, 0xF1, 0xF0, 0x02};
static const uint8_t PN7160_SET_CONFIG_CMD_DPLL_32MHZ[] = {
    0x20, 0x02, 0x0C, 0x01, 0xA0, 0x26, 0x08, 0xB0,
    0x01, 0xA3, 0x82, 0x88, 0x01, 0xE2, 0x02};
static const uint8_t PN7160_SET_CONFIG_CMD_PLL_38_4MHZ[] = {
    0x20, 0x02, 0x0C, 0x01, 0xA0, 0x20, 0x08, 0x88,
    0x51, 0xE3, 0x82, 0xB8, 0x21, 0xE1, 0x02};
static const uint8_t PN7160_SET_CONFIG_CMD_DPLL_38_4MHZ[] = {
    0x20, 0x02, 0x0C, 0x01, 0xA0, 0x26, 0x08, 0x88,
    0x01, 0xE2, 0x82, 0xF0, 0x00, 0xA2, 0x01};
static const uint8_t PN7160_SET_CONFIG_CMD_PLL_48MHZ[] = {
    0x20, 0x02, 0x0C, 0x01, 0xA0, 0x20, 0x08, 0x38,
    0x51, 0xD3, 0x82, 0x58, 0xE1, 0xE0, 0x02};
static const uint8_t PN7160_SET_CONFIG_CMD_DPLL_48MHZ[] = {
    0x20, 0x02, 0x0C, 0x01, 0xA0, 0x26, 0x08, 0x38,
